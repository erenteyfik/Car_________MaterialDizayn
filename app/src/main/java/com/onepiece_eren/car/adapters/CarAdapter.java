package com.onepiece_eren.car.adapters;
...
import com.onepiece_eren.car.extra.ImageHelper;
...
public class CarAdapter extends RecyclerView.Adapter<CarAdapter.MyViewHolder> {
    ...
    private RecyclerViewOnClickListenerInterface mRecyclerViewOnClickListenerImterface;
    private float scale;
    private int width;
    private int height;
    ...
    public void RecyclerViewOnClickListenerInterface (RecyclerViewOnClickListenerInterface   r){
        mRecyclerViewOnClickListenerImterface = r;
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public MyViewHolder(View itemView) {
            ...
            tvBrand = (TextView) itemView.findViewById(R.id.tv_marka);
        ...
        public void onClick(View v) {
            if(mRecyclerViewOnClickListenerImterface != null){
                mRecyclerViewOnClickListenerImterface.onClickListener(v, getPosition());
            }
        }
    }
}
